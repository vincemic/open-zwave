...
namespace OpenZWave
{
	...
	private:
		...
		void SetHomeNodeIdAndInstance ( uint32 const _homeId, uint8 const _nodeId, uint32 const _instance, uint8 const _endpoint ){ m_valueId = ValueID( _homeId, _nodeId, _instance, _endpoint ); }
