...
(
	...
	uint8 const _endpointId
  	...
  	Value( _homeId, _nodeId, _genre, _commandClassId, _instance, _index, ValueID::ValueType_Short, _label, _units, _readOnly, _writeOnly, false, _pollIntensity, _endpointId ),
	m_value( _value ),
	m_valueCheck( 0 )
{
	m_min = SHRT_MIN;
